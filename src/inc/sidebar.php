...
<div id="sidebar" class="col-12 col-lg-2 order-first text-center px-0 mb-3 mb-lg-0">
    <svg id="toggleMobileMenu" class="text-white p-2 mt-2 mx-4 d-block d-lg-none text-start"
        style="width: 48px; cursor: pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24"
    ...
    <div class="border sidebar-border p-2 mt-2 mx-4 bg-white">
        <!-- Info -->
        <img src="./assets/img/stalogo.png" class="rounded img-fluid" alt="St. Augustine CHS Logo" />
    ...
    <div id="navbar" class="d-none d-lg-block">
        ...
        ?>
        <a href="./" class="btn mt-5 p-4 sidebar-button-nav <?php
                if ($base == "index.php") {
            ...
            ?>" type="button">Home</a>
        <a href="./links" class="btn mt-1 p-4 sidebar-button-nav <?php
                if ($base == "links.php") {
                    echo "text-white bg-red";
                } else {
                    echo "bg-white";
            ...
            ?>" type="button">Links</a>
        <a href="./additionalinfo" class="btn mt-1 p-4 sidebar-button-nav <?php
                if ($base == "additionalinfo.php") {
                    echo "text-white bg-red";
                } else {
                    echo "bg-white";
                }
            ?>" type="button">Additional Info</a>
    </div>
</div>